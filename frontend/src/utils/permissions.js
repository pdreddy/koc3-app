...
const ROLE_CAPABILITIES = {
  ...
  [ROLES.CAPTAIN]: [CAP.VIEW_PUBLIC, CAP.ENTER_SCORE, CAP.MANAGE_OWN_ROSTER],
  [ROLES.ADMIN]: [
    CAP.VIEW_PUBLIC, CAP.ENTER_SCORE, CAP.MANAGE_OWN_ROSTER,
    CAP.EDIT_TEAMS, CAP.EDIT_SCHEDULE, CAP.EDIT_CONFIG, CAP.RUN_PLAYOFFS
  ],
  [ROLES.SUPER_ADMIN]: [
    CAP.VIEW_PUBLIC, CAP.ENTER_SCORE, CAP.MANAGE_OWN_ROSTER,
    CAP.EDIT_TEAMS, CAP.EDIT_SCHEDULE, CAP.EDIT_CONFIG, CAP.RUN_PLAYOFFS,
